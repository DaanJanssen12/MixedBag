...
$(document).ready(function(){
    ...
    readTextFile("data/pokemon/pokedex-full.json", function(text){
        ...
        data.forEach(pokemon => {
            ...
            var $a = $("<a></a>").attr("href", `index.html?module=pokemon&page=pokedex&id=${pokemon.nr}_${pokemon.name.toLowerCase()}`);
            var $picture = $("<picture></picture>");
            var $img = $("<img></img>").addClass("img-fixed").attr("src", `data/pokemon/pokemon/img/${pokemon.nr}_${pokemon.name.toLowerCase()}.png`);
            ...
            if(appsettings.developmentMode){
                readTextFile(`data/pokemon/pokemon/${pokemon.nr}_${pokemon.name.toLowerCase()}.json`, function(pokemonJsonStr){
